...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    Expected Input:
    {
        ...
        "srtKey": "04-california/amazon_transcribe/ine/transcripts/video01.srt",
    ...
    {
        "statusCode": 200,
        "txtKey": "04-california/amazon_transcribe/ine/text/video01.txt",
        "textLength": 15234
    }
    """
    ...
    try:
        ...
        txt_key = f"04-california/amazon_transcribe/ine/text/{base_filename}.txt"
